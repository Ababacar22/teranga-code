...
export function orderedVilles(focusAreas = []) {
...
export function getUnlockInfo(villeId, badges, focusAreas = []) {
  ...
  return {
    ...
    requirement: `Termine ${UNLOCK_THRESHOLD} sujets à ${previousVille.name} pour débloquer`,
...
export function getVille(villeId) {
